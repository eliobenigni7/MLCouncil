...
ASSET_CONTRACTS: dict[str, AssetContract] = {
    ...
    "council_signal": AssetContract(
        required_columns=("ticker", "council_signal", *LINEAGE_COLUMNS),
        unique_key_columns=("ticker",),
        non_null_columns=("ticker", "council_signal", *LINEAGE_COLUMNS),
        allow_empty=True,
    ),
    "portfolio_weights": AssetContract(
        required_columns=("ticker", "target_weight", *LINEAGE_COLUMNS),
        unique_key_columns=("ticker",),
        non_null_columns=("ticker", "target_weight", *LINEAGE_COLUMNS),
        allow_empty=True,
    ),
    "operations_report": AssetContract(
        required_columns=(
            "date",
            "trade_status",
            "runtime_profile",
    ...
    "backtest_metrics": AssetContract(
        required_columns=(
            "sharpe",
            "max_drawdown",
            "turnover",
    ...
    "model_evaluation_metrics": AssetContract(
        required_columns=(
            "sharpe",
            "max_drawdown",
            "turnover",

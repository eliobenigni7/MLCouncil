...
SETTINGS_FIELDS = [
    ...
    },
    {
        ...
        "description": "Operator kill switch for paper execution.",
        "secret": False,
        "placeholder": "false",
    },
    {
        "key": "MLCOUNCIL_MAX_DAILY_ORDERS",
        "label": "Max Daily Orders",
        "description": "Hard cap on the number of paper orders per run.",
        "secret": False,
        "placeholder": "20",
    },
    {
        "key": "MLCOUNCIL_MAX_TURNOVER",
        "label": "Max Turnover",
        "description": "Maximum one-way turnover allowed in pre-trade checks.",
        "secret": False,
        "placeholder": "0.30",
    },
    {
        "key": "MLCOUNCIL_MAX_POSITION_SIZE",
        "label": "Max Position Size",
        "description": "Maximum target weight allowed for a single position.",
        "secret": False,
        "placeholder": "0.10",
    },
    {
